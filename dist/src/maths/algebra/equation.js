        ...
        this._solveDegree2 = (letter) => {
            ...
            if (delta > 0) {
                ...
                if (delta > 1.0e5) {
                    ...
                    nthDelta = new nthroot_1.Nthroot().parse(delta).reduce();
                    if (nthDelta.hasRadical()) {
                        ...
                        this._solutions = [
                            new fraction_1.Fraction(-b - nthDelta.coefficient, 2 * a).reduce().dfrac,
                            new fraction_1.Fraction(-b + nthDelta.coefficient, 2 * a).reduce().dfrac
                        ];
                    }
                }
                ...
                this._solutions = [new fraction_1.Fraction(-b, 2 * a).reduce().dfrac];
            }
            else {
                this._solutions = [this._varnothing];
            }
